...
export default function Home() {
  useSEO(
    ...
    "Leading Pakistani textile manufacturer providing export-quality fabrics."
  )
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="p-10 border hover:shadow-xl transition">
              ...
              <p className="text-gray-600 leading-7">
                Experienced professionals managing every stage from weaving to
                finishing.
              </p>
            </div>
            ...
            <div className="p-10 border hover:shadow-xl transition">
              ...
              <p className="text-gray-600 leading-7">
                International inspection standards to meet global export
                requirements.
              </p>
            </div>
          </div>
